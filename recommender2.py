...
class SignLingoRandomForestRecommender:
    ...
    def recommend(self, current_word, top_n=5, include_similarity=True):
        ...
        return recommendations[['url', 'word']]
...
sample_data=pd.read_csv("learning.csv")


# Initialize recommender
recommender2 = SignLingoRandomForestRecommender(sample_data)

# Get recommendations
print("\nRecommendations for 'apple':")
print(recommender2.recommend('apple', top_n=4)) # type: ignore

# Analyze feature importance
print("\nFeature Importance Analysis:")
print(recommender2.analyze_importance().head())